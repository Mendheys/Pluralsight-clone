...
const Python = () => {
    const dataBase = {
        courses:[
            {
                id:1,
                name:"Core Python: Big Picture",
                by:"by Mark Zamoyta",
                time:"3h 58m"
            },
            {
                id:2,
                name:"Core Python 3.6: Getting Started",
                by:"by Paul D. Sheriff",
                time:"1h 58m"
            },
            {
                id:3,
                name:"Core Python 3.6: Organizing Larger Programs",
                by:"by Barry Luijbregts",
                time:"58m"
            },
            {
                id:4,
                name:"Core Python 3.6: Functions and Functional Programming",
                by:"by Jim Cooper",
                time:"1h 58m"
            },
            {
                id:5,
                name:"Core Python 3.8: Classes and Object-orientation",
                by:"by Prateek Parekh",
                time:"3h 58m"
            },
            {
                id:6,
                name:"Build a Static Site Generator with Python",
                by:"by Jeff Batt",
                time:"1h 8m"
            },
            {
                id:7,
                name:"Add Extensions to a Static Site Generator with Python",
            ...
            {
                id:10,
                name:"Core Python 3.8: Robust Resource and Error Handling",
                by:"by Marcin Hoppe",
                time:"3h 58m"
            }
        ],
