...
const Angular = () => {
    const dataBase = {
        courses:[
            ...
            {
                id:5,
                name:"Styling Angular 12 Applications",
                by:"by Brian Treese",
                time:"3h 58m"
            },
            {
            ...
            {
                id:7,
                name:"Build an Album Store Product Page with Angular",
  ...
  return (
    <div>
        ...
        <br />
        <p>Get started quickly learning the new version of Angular. You will be introduced to Angular core concepts, then discover best practices for setting up Angular apps with its CLI, and finally, begin to explore Angular features like forms.</p>
        <br />
        <div>
            {
