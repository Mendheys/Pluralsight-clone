...
const Cplus = () => {
    const dataBase = {
        courses:[
            {
                id:1,
                name:"C# 9: The Big Picture",
                by:"by Joe Eames",
                time:"3h 58m"
            },
            {
                id:2,
                name:"C# 9: Getting Started",
                by:"by Deborah Kurata",
                time:"1h 58m"
            },
            {
                id:3,
                name:"Controlling Program Flow in C# 9",
                by:"by Mark Zamoyta",
                time:"58m"
            },
            {
                id:4,
                name:"Introduction to the C# 9 Type System",
                by:"by John Papa",
                time:"1h 58m"
            },
            {
            ...
            {
                id:8,
                name:"Working with Arrays and Collections in C# 9",
                by:"by Nate Taylor",
                time:"3h 58m"
            },
            {
                id:9,
                name:"C# Extension Methods",
                by:"by Mark Zamoyta",
                time:"3h 58m"
            },
            {
  ...
  return (
    <div>
        ...
        <h1>C# Development Fundamentals</h1>
